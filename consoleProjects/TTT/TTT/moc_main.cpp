...
static const char qt_meta_stringdata_KeyPressEater[] = {
    "KeyPressEater\0"
};

const QMetaObject KeyPressEater::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_KeyPressEater,
      qt_meta_data_KeyPressEater, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &KeyPressEater::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_KeyPressEater))
        return static_cast<void*>(const_cast< KeyPressEater*>(this));
    return QObject::qt_metacast(_clname);
}
